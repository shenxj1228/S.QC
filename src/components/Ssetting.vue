...
<template>
  <Tabs v-model="defaultTab" style="height:100%; text-align:center">
    ...
    <TabPane label="查询条件展示" name="0">
      ...
      <Transfer style="display: inline-block;margin-top:5%;text-align:left" :titles="listTitle" :data="filterfields" :target-keys="targetKeys1" :list-style="listStyle" :render-format="renderItem" :operations="['隐 藏','显 示']" @on-change="handleChange1">
...
export default {
    ...
    methods: {
        ...
        getFields() {
            ...
            api
                .getFields(this.domainName, this.projectName,'can-filter=true')
                .then(data => {
